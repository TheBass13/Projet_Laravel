            ...
            <div class="col-md-8 col-md-offset-2">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <form class="form-horizontal" role="form" method="POST" action={{url('customer/edit/' . $user->id)}}>
                            {{ csrf_field() }}
                            ...
                            <div class="form-group{{ $errors->has('lastname') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6">
                                    <input id="lastname" type="text" class="form-control" name="lastname" value="{{ $fiche->lastname }}">
                            ...
                            <div class="form-group{{ $errors->has('firstname') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6">
                                    <input id="firstname" type="text" class="form-control" name="firstname" value="{{ $fiche->firstname }}">
                            ...
                            <div class="form-group{{ $errors->has('birthdate') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6">
                                    <input id="birthdate" type="text" class="form-control" name="birthdate" value="{{ $fiche->birthdate}}">
                            ...
                            <div class="form-group{{ $errors->has('birthplace') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6">
                                    <input id="birthplace" type="text" class="form-control" name="birthplace" value="{{ $fiche->birthplace }}">
                            ...
                            <div class="form-group{{ $errors->has('adress') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6">
                                    <input id="adress" type="text" class="form-control" name="adress" value="{{ $fiche->adress }}">
                            ...
                            <div class="form-group{{ $errors->has('city') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6">
                                    <input id="city" type="text" class="form-control" name="city" value="{{ $fiche->city }}">
                            ...
                            <div class="form-group{{ $errors->has('zipcode') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6">
                                    <input id="zipcode" type="number" class="form-control" name="zipcode" value="{{ $fiche->zipcode }}">
                            ...
                            <div class="form-group{{ $errors->has('country') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6">
                                    <input id="country" type="text" class="form-control" name="country" value="{{ $fiche->country }}">
                            ...
                            <div class="form-group{{ $errors->has('phone') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6">
                                    <input id="phone" type="number" class="form-control" name="phone" value="{{ $fiche->phone }}">
